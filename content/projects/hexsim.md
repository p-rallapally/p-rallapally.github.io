...
- My lively presentation at the poster symposium ended up costing me at the Undergrad Slam for being "too theatrical";  lesson learned, know your audience haha
...
[^2]: How the simulations work: the map is split up into a grid of hexagons, each of with has its own environmental data gleaned from map photos with a collective "habitability score". Based on the biological frog data, the software walks through time stages that predict where each individual will move throughout the hexagons, repeated for a custom amount of frogs. 
